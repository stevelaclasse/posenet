This repository presents an university project done with a classmate for single/multi person detection in images and videos, and height inderence (only on images) on android devices.
